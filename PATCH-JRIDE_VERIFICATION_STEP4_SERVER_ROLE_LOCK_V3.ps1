# PATCH-JRIDE_VERIFICATION_STEP4_SERVER_ROLE_LOCK_V3.ps1
# Adds ID-based allowlists:
# - ADMIN_USER_IDS / DISPATCHER_USER_IDS (comma-separated UUIDs)
# Keeps existing email allowlists (JRIDE_ADMIN_EMAILS / ADMIN_EMAILS etc)
# Removes debug payload (back to normal responses)
