# PATCH-JRIDE_PHASE9A_AT_RISK_DASHBOARD_READONLY.ps1
# Phase 9A: At-Risk / Stuck Trips Dashboard (READ-ONLY)
#
# Creates:
#   app/admin/trips/at-risk/page.tsx
#
# Reads ONLY:
#   GET /api/admin/livetrips/page-data
#
# LOCKED:
# - NO wallet mutations
# - NO payout logic
# - NO schema changes
# - NO Mapbox/LiveTrips edits (this page links to LiveTrips only)
...
Ok "[DONE] Phase 9A At-Risk dashboard created."
