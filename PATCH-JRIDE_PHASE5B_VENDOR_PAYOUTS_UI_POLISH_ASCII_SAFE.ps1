# PATCH-JRIDE_PHASE5B_VENDOR_PAYOUTS_UI_POLISH_ASCII_SAFE.ps1
# UI-only polish for app/admin/vendor-payouts/page.tsx
# - Fix mojibake (ASCII only)
# - Better spacing + disabled states
# - Optimistic Mark Paid, auto-close on success
# - Persist "Reviewed by" via localStorage
# - No backend, wallet, or schema changes
...
$target = Join-Path $root "app\admin\vendor-payouts\page.tsx"
...
# ---- Replace entire file with polished, ASCII-safe version ----
$dst = @'
"use client";
