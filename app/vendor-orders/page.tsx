...
function VendorOrdersInner() {
  ...
  // Vendor-side action gating: disable live actions while in pilot/testing
  const vendorActionBlocked = true;

  const vendorActionBlockMessage =
    "Testing Phase Notice: Takeout is under pilot testing. Orders placed now will not be processed.";
  ...
  function vendorCanTransitionUI(o: VendorOrder, to: VendorOrderStatus) {
    // UI-only; backend still validates
  ...
  const todays = useMemo(() => {
    return orders.filter((o) => isSameLocalDay(o.created_at));
  }, [orders]);
          ...
          <div className="flex items-center justify-between gap-3">
            <div>
              ...
              <div className="mt-0.5 text-[11px] text-emerald-900/80">
                For interested food stall owners/vendors: message us on Facebook or visit <span className="font-semibold">jride.net</span>.
              </div>
            </div>
            <a
                          ...
                          <div className="grid gap-2 sm:grid-cols-2">
                            <div className="rounded-lg bg-slate-50 p-2">
                              ...
                              <div className="mt-0.5 text-[12px] text-slate-700">
                                {normText(o.customer_name || "-")}
                              </div>
                              <div className="mt-0.5 text-[12px] text-slate-700">
                                {normText(o.customer_phone || "-")}
                              </div>
                            </div>
                            <div className="rounded-lg bg-slate-50 p-2">
