        ...
        {!premium ? (
          ...
          <div className="mt-3">
            ...
            <div className="mt-2 text-xs opacity-70">
              Photos are automatically resized and compressed so uploads won't slow phones.
            </div>
          </div>
        )}
      </div>
    ...
    <div className="min-h-screen bg-black text-white">
      <div className="mx-auto max-w-6xl px-4 py-8 md:py-12">
        <div className="flex items-start justify-between gap-4">
          <div>
            ...
            <div className="mt-2 text-sm md:text-base opacity-75">
              Start free. Upgrade when you're ready to manage your menu and photos yourself.
            </div>
          </div>
          <Link
            href="/vendor"
        ...
        <div className="mt-6 text-xs opacity-60">
          Note: Photos on this demo page are placeholders. In production, uploads should be auto-optimized.
        </div>
      </div>
    </div>
  );
