    ...
    return NextResponse.json(
      {
        ...
        receipt: {
          ...
          approach_fee: fare.approach_fee,
          configured_base_fare: fare.configured_base_fare,
          base_fare: fare.base_fare,
          pickup_distance_fee: fare.pickup_distance_fee,
          base_absorbed_into_pickup: fare.base_absorbed_into_pickup,
          distance_fare: fare.distance_fare,
          night_rate_mode: fare.night_rate_mode,
          night_rate_hour_ph: fare.night_rate_hour_ph,
          night_rate_eligible_subtotal: fare.night_rate_eligible_subtotal,
          night_rate_adjustment: fare.night_rate_adjustment,
