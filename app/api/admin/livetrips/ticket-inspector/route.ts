    ...
    const serviceDetails = {
      ...
      takeout: serviceType === "takeout"
        ? {
            ...
            pickup_approach_fee: booking?.pickup_distance_fee ?? null,
            product_purchase_amount: booking?.takeout_product_purchase_amount ?? null,
            cash_first_amount: booking?.takeout_cash_first_amount ?? null,
            pay_on_delivery_amount: booking?.takeout_pay_on_delivery_amount ?? null,
            driver_commission: booking?.takeout_driver_commission ?? null,
            company_revenue: booking?.takeout_company_revenue ?? null,
            driver_delivery_earnings: booking?.takeout_driver_delivery_earnings ?? null,
            company_cut: booking?.company_cut ?? null,
