...
export async function POST(
  ...
  try {
    ...
    const joinFunWalk: boolean = body.joinFunWalk;
    ...
    // registered through a different flow entirely. Writing fresh Golden Jubilarian
    // participation onto that pre-existing record would be wrong
    ...
    if (result.success && result.attendeeId) {
      ...
      if (eventError) {
        console.error("golden-jubilarian register: event lookup for participation failed", {
          eventSlug: params.eventSlug,
