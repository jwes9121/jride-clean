// app/dispatch/page.tsx - JRide Dispatch Console (client UI only)
  ...
  return (
    <div className="flex min-h-screen flex-col bg-slate-50">
      ...
      <main className="mx-auto flex w-full max-w-7xl flex-1 flex-col gap-4 px-4 py-4 sm:px-6 lg:px-8 lg:flex-row">
        ...
        {/* CENTER: Assignment and map placeholder */}
          ...
          <div className="rounded-xl border border-slate-200 bg-white p-3 shadow-sm">
            ...
            {!selectedTrip && (
              <div className="mt-2 rounded-md border border-dashed border-amber-200 bg-amber-50 px-2 py-1.5 text-[11px] text-amber-800">
                Tip: start from a <span className="font-semibold">New request</span> on the left, then pick the best JRidah on the right.
              </div>
            )}
          </div>
        ...
        <section className="flex w-full flex-col gap-3 lg:w-[28%]">
              ...
              {filteredDrivers.map((driver) => (
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <span className={selectedDriverId === driver.id ? "text-slate-200" : "text-slate-400"}>
                      {driver.lastSeen}
                    </span>
                  </div>
          ...
          <div className="rounded-xl border border-slate-200 bg-slate-100 p-3 text-[11px] text-slate-600">
            ...
            <ul className="space-y-0.5">
              ...
              <li>• Assign trip button → call your Supabase RPC.</li>
