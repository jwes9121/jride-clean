...
export default function DriverPayoutRequestsReportPage() {
  const card: any = {
  ...
  const presetRequests = `/admin/reports/lgu?tab=driver&view=requests`;

  return (
    <div style={{ padding: 16 }}>
      <h1 style={{ fontSize: 22, fontWeight: 800, margin: 0 }}>Driver Payout Requests (LGU View)</h1>
      <div style={{ marginTop: 6, fontSize: 13, opacity: 0.7 }}>
        Read-only report launcher. Opens LGU export view with driver payout requests preset. No API calls here.
      </div>
      ...
      <div style={{ marginTop: 14, display: "grid", gap: 12 }}>
        <div style={card}>
          ...
          <div style={{ marginTop: 8, display: "flex", gap: 10, flexWrap: "wrap" }}>
            <Link href={presetRequests} style={btn}>
              Open Driver Payout Requests (LGU)
            </Link>
          </div>
