...
export default function DriverDevicesPage() {
  ...
  return <main className="mx-auto max-w-5xl px-4 py-7">
    ...
    <p className="mt-4 rounded-xl bg-amber-50 p-4 text-sm text-amber-950">Match the request code on the driver’s phone and verify the driver before approval. Approving a replacement phone revokes the previous phone’s AgriMarket access. Ride and Errand access are unchanged.</p>
