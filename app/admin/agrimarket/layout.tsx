    ...
    <>
      <nav className="border-b bg-white px-3 py-3 sm:px-5">
        <div className="mx-auto flex max-w-6xl flex-wrap items-center gap-2">
          ...
          <Link href="/admin/agrimarket/catalog-review" className="rounded-xl border bg-white px-3 py-2 text-sm font-semibold text-slate-800">
            Catalog review
          </Link>
          <Link href="/admin/agrimarket/vendors" className="rounded-xl border bg-white px-3 py-2 text-sm font-semibold text-slate-800">Store names</Link>
