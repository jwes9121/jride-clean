...
export default function ManualVendorSuspensionPanel({
  ...
  const ready =
    ...
    !activeSuspendedVendorIds.has(vendorId) &&
    violationCode.length > 0 &&
    vendorMessage.trim().length >= 10 &&
        ...
        <div className="mt-4 grid grid-cols-1 gap-3 lg:grid-cols-2">
          ...
          <label className="text-xs font-bold text-slate-700 lg:col-span-2">
            ...
            <span className="mt-1 block text-[11px] font-normal text-slate-500">
              This exact explanation appears in the vendor portal. Do not include
              customer names, phone numbers, or private evidence.
            </span>
          </label>
          ...
          <label className="text-xs font-bold text-slate-700 lg:col-span-2">
            ...
            />
            <span className="mt-1 block text-[11px] font-normal text-slate-500">
              Admin-only record. This is never returned to the vendor or passenger.
            </span>
          </label>
