    ...
    <form onSubmit={submit}>
      <fieldset disabled={busy || !!attempt || !loaded} className="disabled:opacity-70">
        ...
        <fieldset className={styles.formSection}><legend>03 Pickup details</legend><div className={styles.formGrid}>
          ...
          <label>Vehicle<select value={draft.vehicle_requirement} onChange={event => setDraft({ ...draft, vehicle_requirement: event.target.value })}><option value="either">Motorcycle / Tricycle / Kolong-Kolong</option><option value="motorcycle">Motorcycle</option><option value="tricycle">Tricycle</option><option value="kolong_kolong">Kolong-Kolong</option></select></label>
