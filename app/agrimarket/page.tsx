          ...
          <aside id="agrimarket-cart" className="h-fit rounded-3xl border bg-white p-5 shadow-sm xl:sticky xl:top-4">
            ...
            {quote ? (
              <div className="mt-5 rounded-2xl bg-slate-50 p-4 text-sm">
                ...
                {quote.fulfillment?.is_scheduled_harvest ? <p className="mt-3 rounded-xl bg-amber-50 p-3 text-xs text-amber-900">This reserves the expected quantity. The shown harvest or butchering window is for preparation, not a guaranteed delivery time. After the farmer reports the harvest or butchering ready, JRide may offer the order while final preparation is underway so driver arrival fits the ready time. A driver is assigned only after accepting the offer. You do not need to return online to tap Proceed just because the scheduled time arrived. Any proposed delay or shortfall needs your approval. Check your order status and arrange for someone to receive and pay at the address if you will be away. Never leave cash unattended.</p> : null}
