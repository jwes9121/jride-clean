...
export default function VendorLoginPage() {
  ...
  function handleVendorChange(nextVendorKey: string) {
    ...
    setMessage(
      text(nextVendorKey)
        ? "Enter the vendor UUID and access code issued by JRide admin."
  ...
  const loadVendors = useCallback(async () => {
    ...
    try {
      ...
      setTypedVendorId("");
      setPin("");
      setMessage("Select your town to begin.");
    } catch (e: any) {
      ...
      <div className="mx-auto max-w-3xl space-y-4">
        <section className="rounded-2xl border bg-white p-5 shadow-sm">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
            <div>
              ...
              <p className="mt-1 max-w-2xl text-sm text-slate-600">
                Select your town and vendor name, then enter the UUID and access code issued by JRide admin.
              </p>
            </div>
          ...
          <div className="mt-5 space-y-4">
            ...
            {selectedVendorKey ? (
              <>
                <label className="block text-sm">
                  ...
                  <input
                    value={typedVendorId}
                    onChange={(e) => setTypedVendorId(e.target.value)}
                ...
                <label className="block text-sm">
                  ...
                  <span className="mt-1 block text-xs text-slate-500">
                    Use the access code issued by JRide admin during onboarding.
                  </span>
                </label>
                ...
                {selectedVendor ? (
                  <div className="rounded-xl border bg-slate-50 p-3 text-sm">
                    ...
                    <div className="mt-1 text-xs text-slate-500">
                      UUID required: ask JRide admin if missing.
                    </div>
                  </div>
                ) : null}
              </>
            ...
            <button
              ...
              disabled={verifying || !selectedVendorKey}
        ...
        <section className="rounded-2xl border bg-white p-5 text-sm text-slate-600 shadow-sm">
          ...
          <ul className="mt-2 list-disc space-y-1 pl-5">
            <li>Select the town and vendor name before entering credentials.</li>
