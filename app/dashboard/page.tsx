...
export default async function DashboardPage() {
  ...
  return (
    <>
      <header style={{
        borderBottom: "1px solid #eaeaea", background: "#fff", height: 60,
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <form action="/api/auth/signout" method="post">
            <button type="submit" style={{
              ...
              borderRadius: 6, padding: "6px 10px", background: "white", cursor: "pointer"
            }}>Sign out</button>
          </form>
        </div>
      </header>
      ...
      <main style={{ maxWidth: 1000, margin: "0 auto", padding: "2rem 1rem" }}>
        ...
        <section style={{
          border: "1px solid #eaeaea", borderRadius: 12, background: "#fafafa", padding: "1.5rem"
        }}>
