...
function pluralizeAttendeeLabel(value: string | null | undefined) {
  const label = String(value || "Participant").trim();
...
export default function EventCommandCenterPage() {
  ...
  const primaryAttendeePluralLabel = pluralizeAttendeeLabel(
    summary.primaryAttendeeLabel
  );

  const primaryAttendeePluralLower = primaryAttendeePluralLabel.toLowerCase();
          ...
          {!loading && !error ? (
            <>
              ...
              <div className="mt-6 grid gap-4 md:grid-cols-4">
                <div className="rounded-3xl bg-white p-5 text-slate-950">
                  <p className="text-xs font-black uppercase tracking-[0.2em] text-slate-500">
                    Registered {primaryAttendeePluralLabel}
                  </p>
                  <p className="mt-3 text-5xl font-black">
                ...
                <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                  <div>
                    ...
                    <p className="mt-2 text-2xl font-black">
                      {checkInPct}% of registered {primaryAttendeePluralLower} + guests baseline
                    </p>
              ...
              <div className="mt-5 grid gap-5 lg:grid-cols-3">
                ...
                <div className="rounded-3xl bg-white p-5 text-slate-950">
                  ...
                  <p className="mt-2 text-sm font-semibold text-slate-500">
                    Actual checked-in {primaryAttendeePluralLower} counts only.
                  </p>
                  ...
                  {topBatches.length > 0 ? (
                    ...
                    <p className="mt-5 rounded-2xl bg-slate-100 p-4 font-semibold text-slate-500">
                      No checked-in {primaryAttendeePluralLower} yet.
                    </p>
                  )}
                </div>
              </div>
