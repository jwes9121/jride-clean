...
# ------------------------------------------------------------
# Replace entire file with a deterministic Phase13B version
# (UI-only, GET-only on click, client-side date filter + presets)
# ------------------------------------------------------------
$new = @'
"use client";
...
Write-Utf8NoBom $page $new

Write-Host ""
Write-Host "[DONE] PHASE13B: Finance Summary date presets + custom range filter (client-side, GET-only, no new APIs)."
