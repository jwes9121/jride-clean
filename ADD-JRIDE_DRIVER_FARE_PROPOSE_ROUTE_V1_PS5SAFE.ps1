# ADD-JRIDE_DRIVER_FARE_PROPOSE_ROUTE_V1_PS5SAFE.ps1
...
Ok "== JRIDE ADD: /api/driver/fare/propose (V1) =="

$dir = Join-Path $RepoRoot "app\api\driver\fare\propose"
New-Item -ItemType Directory -Force -Path $dir | Out-Null
$target = Join-Path $dir "route.ts"

if (Test-Path -LiteralPath $target) {
  Ok "[OK] route.ts already exists, will overwrite."
}
