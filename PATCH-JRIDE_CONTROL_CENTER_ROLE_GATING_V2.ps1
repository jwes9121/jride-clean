# PATCH-JRIDE_CONTROL_CENTER_ROLE_GATING_V2.ps1
# Role-aware control center:
# - role=admin => admin open enabled
# - role=dispatcher => admin open disabled/gray; dispatcher link enabled
# Uses live pending count from /api/admin/verification/pending (no-store)
...
WriteU $f $code
Write-Host "[OK] Patched control center with role gating (role=dispatcher disables admin actions)."
