...
alter table public.agrimarket_orders
  add constraint agrimarket_orders_customer_request_uidx
...
revoke all on function public.agrimarket_create_reserved_order_v2(uuid, uuid, jsonb, numeric, integer, text, text) from service_role;
revoke all on function public.agrimarket_create_reserved_order_v2(uuid, uuid, uuid, jsonb, numeric, integer, text, text) from public, anon, authenticated;
grant execute on function public.agrimarket_create_reserved_order_v2(uuid, uuid, uuid, jsonb, numeric, integer, text, text) to service_role;
