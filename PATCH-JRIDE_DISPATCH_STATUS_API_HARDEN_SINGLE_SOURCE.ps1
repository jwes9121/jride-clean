# PATCH-JRIDE_DISPATCH_STATUS_API_HARDEN_SINGLE_SOURCE.ps1
...
# Rewrite the file to a single hardened implementation (no mixed code paths).
$new = @'
...
Ok "Rewrote: $rel (single hardened implementation)"
Info "Done."
