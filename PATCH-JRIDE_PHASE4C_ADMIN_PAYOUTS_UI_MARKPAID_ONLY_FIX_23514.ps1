# PATCH-JRIDE_PHASE4C_ADMIN_PAYOUTS_UI_MARKPAID_ONLY_FIX_23514.ps1
# Fixes 23514 check constraint issue by removing approve/reject actions from UI.
# Keeps Mark Paid only (pending -> paid). Also fixes mojibake dash and improves error message display.
...
$target = Join-Path $root "app\admin\driver-payouts\page.tsx"
...
Ok "[OK] Phase 4C UI updated: Mark Paid only (fix 23514 approve constraint)"
Ok "[DONE]"
