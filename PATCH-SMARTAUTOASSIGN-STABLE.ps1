# PATCH-SMARTAUTOASSIGN-STABLE.ps1
# Rewrites SmartAutoAssignSuggestions.tsx to be defensive, stable, ASCII-only separators (no mojibake).
# Does NOT touch Mapbox or other LiveTrips layout.
...
Write-Utf8NoBom $f $code
Write-Host "OK: SmartAutoAssignSuggestions rewritten (defensive + ASCII-only + UTF8 no BOM)." -ForegroundColor Green
Write-Host "Next: restart dev server." -ForegroundColor Cyan
