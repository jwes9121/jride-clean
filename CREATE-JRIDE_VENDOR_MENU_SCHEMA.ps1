# CREATE-JRIDE_VENDOR_MENU_SCHEMA.ps1
# Writes a clean vendor menu + day_state + snapshot schema to a .sql file (UTF-8 no BOM)
...
$root = Get-Location
$outFile = Join-Path $root "SQL-JRIDE_VENDOR_MENU_SCHEMA.sql"
...
Write-Host "2) Paste/run contents of SQL-JRIDE_VENDOR_MENU_SCHEMA.sql" -ForegroundColor Cyan
