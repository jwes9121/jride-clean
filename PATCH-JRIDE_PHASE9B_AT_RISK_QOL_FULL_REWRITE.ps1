# PATCH-JRIDE_PHASE9B_AT_RISK_QOL_FULL_REWRITE.ps1
# Phase 9B: At-Risk Trips QoL Enhancements (READ-ONLY) — FULL FILE REWRITE (SAFE)
# - Copy booking_code / driver_id / trip_id (clipboard)
# - Toast feedback
# - Severity badges (warn/high/critical) based on mins vs thresholds
# - Extra link-only navigation helpers
# - UI polish (spacing, monospace IDs)
#
# LOCKED:
# - NO wallet mutations
# - NO payout logic
# - NO schema changes
# - NO LiveTrips/Mapbox edits (this page links to LiveTrips only)
...
$dir  = Join-Path $root "app\admin\trips\at-risk"
...
Ok "[DONE] Phase 9B applied (full rewrite): $file"
