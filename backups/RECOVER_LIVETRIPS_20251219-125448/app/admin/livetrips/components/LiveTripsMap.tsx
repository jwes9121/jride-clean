...
const selectedOverview = useMemo(() => {
 ...
 // ===== MAP RESIZE (prevents white gaps / markers drifting after layout changes) =====
 useEffect(() => {
 ...
 // Initial resize (after mount / reflow)
 safeResize();
...
// ===== MARKERS + ROUTES =====
 ...
 {selectedOverview && (
 <div style={{ maxHeight: "100%", overflowY: "auto", WebkitOverflowScrolling: "touch", zIndex: 50 }} className="pointer-events-auto absolute bottom-3 right-3 z-20 w-80 rounded-xl bg-white/90 p-3 text-xs shadow-md space-y-2">
 <div style={{ maxHeight: "100%", overflowY: "auto", WebkitOverflowScrolling: "touch", zIndex: 50 }} className="mb-1 flex items-center justify-between">
 <span className="font-semibold text-slate-800">
...
>
 ...
 <div data-jride-dispatch-panel-wrapper style={{
 position: "absolute",
 top: 12,
 right: 12,
 zIndex: 60,
 ...
 WebkitOverflowScrolling: "touch",
 pointerEvents: "auto",
}}>{/* LIVE_TRIPS_PANEL_WRAPPER */}
<div style={{ position: 'absolute', top: 12, right: 12, bottom: 12, width: 360, maxWidth: '92vw', overflowY: 'auto', zIndex: 50, pointerEvents: 'auto' }}>
 <DispatchActionPanel />
</div>
