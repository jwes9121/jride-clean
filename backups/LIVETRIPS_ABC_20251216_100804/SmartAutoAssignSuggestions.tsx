    ...
    return (
      <div className="text-[11px] text-slate-400">
        {deliveryMode ? (
          ...
          <>
            No eligible drivers from <span className="font-semibold">{trip.zone}</span>{" "}
  ...
  return (
    <div className="space-y-1">
      {suggestions.map((d) => {
        ...
        const disabled = isAssigned || isAssigning || !!assigningDriverId;

        const label = isAssigned ? "Assigned" : isAssigning ? "Assigning..." : "Assign";
        ...
        return (
          ...
          >
            ...
            <button
              ...
              title={isAssigned ? "This trip is already assigned to this driver." : "Assign (reassigns this trip if already assigned)."}
            >
              {label}
            </button>
          </div>
