      ...
      <div className="grid grid-cols-4 gap-1.5">
        ...
        <div className="col-span-4 grid grid-cols-3 gap-1.5 mt-2 pt-2 border-t border-slate-800">
          <button
            ...
            disabled={selectedTrip.status !== "assigned" || isLoading(`status:on_the_way`)}
            className={[
              baseBtn,
              selectedTrip.status !== "assigned" ? disabledClasses : enabledClasses,
            ].join(" ")}
          >
            <span className="text-lg leading-none">🚗</span>
          ...
          <button
            ...
            disabled={selectedTrip.status !== "on_the_way" || isLoading(`status:on_trip`)}
            className={[
              baseBtn,
              selectedTrip.status !== "on_the_way" ? disabledClasses : enabledClasses,
            ].join(" ")}
          >
          ...
          <button
            ...
            disabled={selectedTrip.status !== "on_trip" || isLoading(`status:completed`)}
            className={[
              baseBtn,
              selectedTrip.status !== "on_trip" ? disabledClasses : enabledClasses,
            ].join(" ")}
          >
            <span className="text-lg leading-none">🏁</span>
            <span>Drop off</span>
