                ...
                >
                  ...
                  {s.distanceMeters != null && (
                    <div className="text-[10px] text-slate-500">
                      ~{(s.distanceMeters / 1000).toFixed(2)} km away ÃƒÆ’Ã†'Ãƒ¢Ã¢â€š¬Ã…¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚·{" "}
                      {s.reason}
                    </div>
                  )}
                </li>
            ...
            <div className="space-y-1 text-[11px] text-slate-700">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium">
                  ...
                  {selectedOverview.isStuck ? " ÃƒÆ’Ã†'Ãƒ¢Ã¢â€š¬Ã…¡ÃƒÆ’Ã¢â‚¬Å¡Ãƒâ€šÃ‚· STUCK" : ""}
                </span>
              </div>
              <div className="flex justify-between">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium">
                  {selectedOverview.lastUpdate
                    ...
                    : "ÃƒÆ’Ã†'Ãƒâ€šÃ‚¢ÃƒÆ’Ã‚¢Ãƒ¢Ã¢â€š¬Ã…¡Ãƒâ€šÃ‚¬ÃƒÆ’Ã‚¢Ãƒ¢Ã¢â‚¬Å¡Ã‚¬Ãƒâ€šÃ‚"}
                </span>
              </div>
            </div>
