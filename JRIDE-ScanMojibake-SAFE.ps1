...
$url = "http://127.0.0.1:3000/api/admin/livetrips/page-data?debug=1"
...
# Plain ASCII markers that indicate mojibake (NO regex)
$markers = @("??", "??", "??")
...
Write-Host ""
Write-Host "Done. Any [MOJIBAKE] lines above show the exact field causing the issue." -ForegroundColor Green
