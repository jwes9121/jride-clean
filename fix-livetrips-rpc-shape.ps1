# fix-livetrips-rpc-shape.ps1
# Adjusts getLiveTrips.ts to handle JSON-wrapped RPC result shapes from
# admin_get_live_trips_page_data() and map them into LiveTrip objects.

$root = "C:\Users\jwes9\Desktop\jride-clean-fresh"
$actionsDir = Join-Path $root "app\admin\livetrips\actions"
...
Write-Host "✅ Rewrote $actionsPath with RPC shape unwrapping."
