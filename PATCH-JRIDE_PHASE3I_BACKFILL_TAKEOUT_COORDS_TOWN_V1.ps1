# PATCH-JRIDE_PHASE3I_BACKFILL_TAKEOUT_COORDS_TOWN_V1.ps1
# Creates: app/api/admin/livetrips/backfill-takeout/route.ts
# Backend-only, schema-safe updates, no UI/auth/wallet/schema edits.
# UTF-8 no BOM. Backup if file exists.
...
$rel = "app\api\admin\livetrips\backfill-takeout\route.ts"
...
if (Test-Path $target) {
  ...
  Info "Target will be created: $target"
}
