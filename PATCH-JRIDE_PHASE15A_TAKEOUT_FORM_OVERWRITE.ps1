# PATCH-JRIDE_PHASE15A_TAKEOUT_FORM_OVERWRITE.ps1
# Overwrite app/takeout/page.tsx with a minimal takeout order form that POSTs to /api/vendor-orders
# One file only. PowerShell only.
