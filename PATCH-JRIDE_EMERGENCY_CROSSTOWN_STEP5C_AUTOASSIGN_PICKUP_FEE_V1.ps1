# PATCH-JRIDE_EMERGENCY_CROSSTOWN_STEP5C_AUTOASSIGN_PICKUP_FEE_V1.ps1
# STEP 5C ONLY:
# - Compute pickup_distance_km (driver -> pickup) using bestDistance
# - If is_emergency: apply free 1.5km, compute extra pickup fee
# - Try to persist fee/distance to bookings WITHOUT assuming columns exist (best-effort)
# - Always return computed values in JSON response
# Target: app\api\dispatch\auto-assign\route.ts
# NOTE: This rewrites the file to a clean known-good version to avoid prior partial injections.
