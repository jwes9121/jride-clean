# ADD-JRIDE_PUBLIC_PASSENGER_BOOKING_POLL_ROUTE.ps1
# Creates missing live-poll route:
...
$dir = "app\api\public\passenger\booking"
$file = Join-Path $dir "route.ts"

if (!(Test-Path $dir)) {
  New-Item -ItemType Directory -Force -Path $dir | Out-Null
  Ok "Created folder: $dir"
}

if (Test-Path $file) { Fail "File already exists: $file (refusing to overwrite)" }
