# PATCH-JRIDE_ADMIN_VERIFICATION_DECIDE_FEEDBACK_V1.ps1
# Replaces app/admin/verification/page.tsx with a client page that:
# - shows status text on approve/reject
...
$root = Get-Location
$stamp = NowStamp
$f = Join-Path $root "app\admin\verification\page.tsx"
...
WriteU $f $code
Write-Host "[OK] Patched admin verification page with visible decide feedback + busy state."
