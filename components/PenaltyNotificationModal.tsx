            ...
            <div className="mt-3 pt-3 border-t border-current border-opacity-20">
              <div className="flex justify-between items-center">
                ...
                <span className={`font-bold text-lg ${style.accent}`}>
                  Ã¢â€š±{penalty.amount.toFixed(2)}
                </span>
              </div>
            </div>
          )}
          ...
          <div className="bg-blue-50 rounded-xl p-3 mb-4">
            <div className="flex items-start">
              ...
              <div className="text-xs text-blue-800">
                ...
                <p>Ã¢â‚¬¢ Respond to order confirmations within 3 minutes</p>
                <p>Ã¢â‚¬¢ Maintain honest passenger count declarations</p>
                <p>Ã¢â‚¬¢ Follow all service guidelines</p>
              </div>
            </div>
          </div>
        )}
          ...
          <div className="bg-orange-50 rounded-xl p-3 mb-4">
            <div className="flex items-start">
              ...
              <div className="text-xs text-orange-800">
                ...
                <p>Amount deducted from wallet Ã¢â€ ' points Ã¢â€ ' next top-up. Continue following guidelines to avoid suspension.</p>
              </div>
            </div>
          </div>
        )}
