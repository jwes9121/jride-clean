                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-xs text-gray-500 space-y-1">
                          ...
                          <div className="flex items-center space-x-1">
                            ...
                            <span>{landmark.tagged_user?.full_name} Ã¢â‚¬¢ {formatDate(landmark.created_at)}</span>
                          </div>
                        </div>
                      </div>
                ...
                <div className="flex items-start space-x-2">
                  ...
                  <div>
                    ...
                    <ul className="text-xs text-yellow-700 space-y-1">
                      <li>Ã¢â‚¬¢ Names should be clear and specific</li>
                      <li>Ã¢â‚¬¢ Avoid duplicate or similar landmarks</li>
                      <li>Ã¢â‚¬¢ Check location accuracy</li>
                      <li>Ã¢â‚¬¢ Ensure it's a useful reference point</li>
                    </ul>
                  </div>
                </div>
              </div>
