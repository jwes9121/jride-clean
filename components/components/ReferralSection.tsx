...
export default function ReferralSection() {
  ...
  const shareReferralCode = async () => {
    if (stats?.referralCode && stats?.referralLink) {
      const shareText = `Join J-Ride using my referral code: ${stats.referralCode}\n\nNew passengers get Ã¢â€š±30 free ride credit!\nI get 15 points (Ã¢â€š±15 ride credit) when you complete your first ride.\n\nSign up here: ${stats.referralLink}`;
    ...
    <div className="bg-white rounded-xl shadow-sm border">
      <div className="p-4 border-b">
        ...
        <p className="text-sm text-gray-600 mt-1">
          Refer new passengers and earn 15 points (Ã¢â€š±15 ride credit) each
        </p>
      </div>
          ...
          <div className="space-y-4">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-xl p-3">
              ...
              <ul className="text-sm text-blue-700 space-y-1">
                <li>Ã¢â‚¬¢ New passengers get Ã¢â€š±30 free ride credit (valid 7 days)</li>
                <li>Ã¢â‚¬¢ You earn 15 points when they complete their first ride</li>
                <li>Ã¢â‚¬¢ 1 point = Ã¢â€š±1 ride credit (auto-applied at checkout)</li>
                <li>Ã¢â‚¬¢ {JSON.parse(localStorage.getItem('j-ride-user') || '{}').user_type === 'driver' ? 'Drivers can only refer passengers' : 'Passengers can refer other passengers'}</li>
              </ul>
            </div>
