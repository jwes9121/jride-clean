      ...
      <div className="relative z-10">
        ...
        <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 mb-3">
          <div className="flex items-center justify-between mb-2">
            ...
            <span className="text-2xl font-bold">Ã¢â€š±{freeRideData.creditAmount}</span>
          </div>
          ...
          <div className="flex items-start space-x-2">
            ...
            <div>
              ...
              <ul className="text-xs opacity-90 mt-1 space-y-1">
                <li>Ã¢â‚¬¢ Book any ride up to Ã¢â€š±{freeRideData.creditAmount}</li>
                <li>Ã¢â‚¬¢ Select "Free Ride Credit" as payment method</li>
                <li>Ã¢â‚¬¢ Credit expires in {freeRideData.expiresAt ? formatTimeRemaining(freeRideData.expiresAt) : 'soon'}</li>
                <li>Ã¢â‚¬¢ Can only be used once</li>
              </ul>
            </div>
          </div>
        </div>
