                        ...
                        <div className="flex-1">
                          <div className="flex items-center space-x-2 mb-1">
                            <h4 className="font-semibold text-gray-800">
                              {fare.route_from} â†’ {fare.route_to}
                            </h4>
                          ...
                          <div className="grid grid-cols-2 gap-4 mb-2">
                            <div>
                              ...
                              <div className="text-lg font-bold text-purple-600">â‚±{fare.driver_proposed_fare}</div>
                            </div>
                            {fare.current_standard_fare && (
                              <div>
                                <span className="text-xs text-gray-500">Current Standard</span>
                                <div className="text-lg font-bold text-gray-600">â‚±{fare.current_standard_fare}</div>
                              </div>
                            )}
                          </div>
                          ...
                          <div className="text-xs text-gray-500 space-y-1">
                            ...
                            <div className="flex items-center space-x-1">
                              ...
                              <span>{fare.driver_name} â€¢ {formatDate(fare.created_at)}</span>
                            </div>
                            {fare.distance_km && (
                              <div className="flex items-center space-x-1">
          ...
          <div className="bg-white rounded-2xl w-full max-w-md max-h-[90%] overflow-y-auto">
            ...
            <div className="p-4 space-y-4">
              ...
              <div className="bg-gray-50 p-3 rounded-lg">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <div className="text-lg font-bold text-purple-600">â‚±{selectedFare.driver_proposed_fare}</div>
                  </div>
                  {selectedFare.current_standard_fare && (
                    <div>
                      <span className="text-xs text-gray-500">Current</span>
                      <div className="text-lg font-bold text-gray-600">â‚±{selectedFare.current_standard_fare}</div>
                    </div>
                  )}
                </div>
                ...
                {selectedFare.current_standard_fare && (
                  <div className="mt-2 text-xs text-gray-600">
                    ...
                    <span className={
                      ...
                      {selectedFare.driver_proposed_fare > selectedFare.current_standard_fare ? '+' : ''}
                      â‚±{selectedFare.driver_proposed_fare - selectedFare.current_standard_fare}
                    </span>
                  </div>
                )}
              </div>
                ...
                <div className="flex items-start space-x-2">
                  ...
                  <div>
                    ...
                    <ul className="text-xs text-green-700 space-y-1">
                      <li>â€¢ Base fare: â‚±30 for local trips</li>
                      <li>â€¢ Long distance: â‚±5-10 per km</li>
                      <li>â€¢ Difficult terrain: +â‚±10-20</li>
                      <li>â€¢ Peak hours: +â‚±5-15</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div className="flex space-x-3 pt-2">
                ...
                >
                  {loading ? 'Approving...' : `Approve â‚±${adjustedFare}`}
                </button>
              </div>
            </div>
          </div>
