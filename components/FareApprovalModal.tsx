                        ...
                        <div className="flex-1">
                          ...
                          <div className="grid grid-cols-2 gap-4 mb-2">
                            <div>
                              ...
                              <div className="text-lg font-bold text-purple-600">₱{fare.driver_proposed_fare}</div>
                            </div>
                            {fare.current_standard_fare && (
                              <div>
                                <span className="text-xs text-gray-500">Current Standard</span>
                                <div className="text-lg font-bold text-gray-600">₱{fare.current_standard_fare}</div>
                              </div>
                            )}
                          </div>
                          ...
                          <div className="text-xs text-gray-500 space-y-1">
                            ...
                            <div className="flex items-center space-x-1">
                              ...
                              <span>{fare.driver_name} • {formatDate(fare.created_at)}</span>
                            </div>
                            {fare.distance_km && (
                              <div className="flex items-center space-x-1">
          ...
          <div className="bg-white rounded-2xl w-full max-w-md max-h-[90%] overflow-y-auto">
            ...
            <div className="p-4 space-y-4">
              ...
              <div className="bg-gray-50 p-3 rounded-lg">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <div className="text-lg font-bold text-purple-600">₱{selectedFare.driver_proposed_fare}</div>
                  </div>
                  {selectedFare.current_standard_fare && (
                    <div>
                      <span className="text-xs text-gray-500">Current</span>
                      <div className="text-lg font-bold text-gray-600">₱{selectedFare.current_standard_fare}</div>
                    </div>
                  )}
                </div>
                ...
                <div className="flex items-start space-x-2">
                  ...
                  <div>
                    ...
                    <ul className="text-xs text-green-700 space-y-1">
                      <li>• Base fare: ₱30 for local trips</li>
                      <li>• Long distance: ₱5-10 per km</li>
                      <li>• Difficult terrain: +₱10-20</li>
                      <li>• Peak hours: +₱5-15</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div className="flex space-x-3 pt-2">
                ...
                >
                  {loading ? 'Approving...' : `Approve ₱${adjustedFare}`}
                </button>
              </div>
            </div>
          </div>
