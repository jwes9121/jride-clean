# PATCH-PHASE4-PING-ENDPOINT-INSERTSAFE.ps1
# Fix POST 500 by making insert path safe when id has no DB default.
# Then: npm.cmd run build, commit, tag.
...
& git commit -m "JRIDE_PHASE4 ping endpoint insert-safe (generate id if needed)"

$tag = "JRIDE_PHASE4_PING_FIX_$(Get-Date -Format 'yyyyMMdd_HHmmss')"
