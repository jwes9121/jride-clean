# PATCH-JRIDE_PHASE6E_UI_SHOW_ASSIGN_RESULT.ps1
# Phase 6E UI: show booking id + assign result returned by /api/public/passenger/book
...
if (!(Test-Path $ridePage)) { throw "Missing: $ridePage" }
BackupFile $ridePage

# Replace the entire file with the current Phase 6D version plus enhanced result parsing.
$rideTs = @'
"use client";
