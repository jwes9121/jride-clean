...
const checks=['scripts/agrimarket-db-checks.sql','scripts/agrimarket-registration-db-checks.sql','scripts/agrimarket-device-db-checks.sql'].map(file=>fs.readFileSync(file,'utf8')).join('\n');
