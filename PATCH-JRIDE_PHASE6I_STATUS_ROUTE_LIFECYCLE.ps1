# PATCH-JRIDE_PHASE6I_STATUS_ROUTE_LIFECYCLE.ps1
# Phase 6I: Add dispatch status lifecycle route (requested->assigned->...->completed/cancelled)
# File:
...
$statusRoute = "app\api\dispatch\status\route.ts"
EnsureDir (Split-Path $statusRoute)
BackupFile $statusRoute
...
WriteUtf8NoBom $statusRoute $ts
Write-Host "[OK] Wrote: $statusRoute"
