# GEN-PHASE3J_TAKEOUT_COORDS_BACKFILL_SQL.ps1
# Generates a schema-aware SQL backfill script (no guessing; prints NOTICEs if sources aren't found).
# Output: scripts\PHASE3J_TAKEOUT_COORDS_BACKFILL.sql (UTF-8 no BOM)
...
$outPath = Join-Path $outDir "PHASE3J_TAKEOUT_COORDS_BACKFILL.sql"
