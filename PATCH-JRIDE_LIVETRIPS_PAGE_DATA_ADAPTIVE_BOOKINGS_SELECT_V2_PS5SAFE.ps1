# PATCH-JRIDE_LIVETRIPS_PAGE_DATA_ADAPTIVE_BOOKINGS_SELECT_V2_PS5SAFE.ps1
param(
...
Write-Host "== PATCH JRIDE LIVETRIPS PAGE-DATA ADAPTIVE BOOKINGS SELECT V2 (PS5-safe) =="
...
$backup = Join-Path $backupDir ("route.ts.bak.LIVETRIPS_PAGE_DATA_ADAPTIVE_BOOKINGS_SELECT_V2." + $stamp)
