# PATCH-JRIDE_PHASE3M2_RECONCILE_WALLETS_FIX_NO_COMPLETED_AT_V1.ps1
# Fixes /api/admin/reconcile-wallets when bookings.completed_at does not exist
# - removes completed_at from SELECT + outputs
# - uses updated_at only
# UTF-8 without BOM
