# PATCH-JRIDE_PHASE6H2_BOOK_CALLS_DISPATCH_ASSIGN.ps1
# Phase 6H2: enforce busy lock by making passenger book route call dispatch/assign
# Single source of truth: app/api/dispatch/assign/route.ts
# Files:
