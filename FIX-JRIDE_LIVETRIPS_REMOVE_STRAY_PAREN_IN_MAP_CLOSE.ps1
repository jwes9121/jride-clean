# FIX-JRIDE_LIVETRIPS_REMOVE_STRAY_PAREN_IN_MAP_CLOSE.ps1
# Fix: remove the stray ')' in the visibleTrips map close tail:
#   );
#   })}
# becomes:
#   );
#   }}
# This matches scanner:
#   [MISMATCH] Closing ')' with EMPTY stack near line ~668
...
# Target ONLY the close tail right before the empty-state block:
# </tr>
# );
# })}
#
