# PATCH-DISPATCH-OBSERVABILITY-POLISH.ps1
# Full file replace: app/dispatch/page.tsx
# - Adds dispatcher name input (persisted in localStorage)
# - Sends x-dispatcher-name header on every action
# - Improves Observability badges + Copy JSON
