...
Write-Host "== JRIDE Patch: LiveTrips driver tab recovery (V3 / PS5-safe) =="
...
Backup-File -Path $clientPath -Tag "LIVETRIPS_DRIVER_TAB_RECOVERY_V3"
Backup-File -Path $routePath -Tag "LIVETRIPS_DRIVER_TAB_RECOVERY_V3"
